...
class BeansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bean" do
    assert_difference("Bean.count") do
      post beans_url, params: { bean: { bean_type: @bean.bean_type, description: @bean.description, price: @bean.price, product_name: @bean.product_name, quantity: @bean.quantity, supplier_id: @bean.supplier_id } }
    end
  ...
  test "should update bean" do
    patch bean_url(@bean), params: { bean: { bean_type: @bean.bean_type, description: @bean.description, price: @bean.price, product_name: @bean.product_name, quantity: @bean.quantity, supplier_id: @bean.supplier_id } }
